...
<template>
  ...
  >
    ...
    <Column field="name" :header="$t('table.Name')" style="min-width: 16rem"></Column>

    <Column field="category" :header="$t('table.Category')" style="min-width: 10rem">
      <template #body="slotProps">
        <span>{{ slotProps.data.category.name }}</span>
      </template>
    </Column>
    <Column field="status" :header="$t('table.Status')" style="min-width: 10rem">
      <template #body="slotProps">
        <span>{{ slotProps.data.status.name }}</span>
      </template></Column
    >
    <Column field="createdAt" :header="$t('table.created_at')" style="min-width: 10rem">
      <template #body="slotProps">
